...
# mgl function. Creates new directory, makes a git repo, sets remote to
# gitlab, pushes the repo to gitlab.
mgl() {
    [ $# -eq 0 ] && return 1
    repoName=$1
    username=ckdcreations
    ...
    then
        ...
        echo "Error creating gitlab repo $repoName"
    fi
}
...
export PATH="/home/beatleboy07/.local/bin:$PATH"
